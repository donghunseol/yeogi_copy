...
public interface ReservationRepository extends JpaRepository<Reservation, Integer> {
    ...
    @Query("SELECT r FROM Reservation r JOIN FETCH r.room ro JOIN FETCH ro.stay WHERE r.user.id = :userId AND r.id = :reservationId")
    Reservation findByUserIdAndReservationIdWithRoomAndStay(@Param("userId") Integer userId, @Param("reservationId") Integer reservationId);

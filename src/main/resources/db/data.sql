...
-- stay 더미 생성
insert into stay_tb(company_id, name, category, address, gps_lat, gps_lng, intro, information, created_at, state)
values (1, '호텔 블루 하버', '호텔', '부산시 해운대구 좌동순환로 99 (좌동)', 35.1696797, 129.1745542, '해운대 최고의 오션뷰를 자랑하는 숙소!', '객실 내 취사 금지', now(), 'TRUE'),
       (2, '호텔 오아시스', '호텔', '경상남도 창원시 원이대로 998 (상남동)', 35.2183679, 128.6844565, '창원시 최고의 반쪽 숙소!', '객실 내 취사 금지', now(), 'TRUE'),
       (3, '호텔 미라클랜드', '호텔', '서울시 중구 장충동2가 300', 37.5549908, 127.0005905, '서울시 중구의 중구파 숙소!', '객실 내 취사 금지', now(), 'TRUE'),
       (4, '프리미어 캐빈-오사카', '해외', '오사카 신사이바시', 34.6724248, 135.5010362, '텐진역에서 5분거리에 위치한 숙소', '객실 내 취사 금지', now(), 'TRUE'),
       (5, '오리엔탈 익스프레스', '해외', '278 Vo Nguyen Giap Street, My An Ward, Ngu Hanh Son District, Da Nang', 16.0531226, 108.2476443, '모든여행지가 가까운 숙소',
        '객실 내 취사 금지', now(), 'TRUE'),
       (6, '소테츠 그랜드 프레사', '해외', '36 - 38 Lam Hoanh, 프억 미, 다낭, 베트남, 550000', 16.0622243, 108.2451814,'신상숙소 내.외간 청결', '객실 내 취사 금지', now(),
        'TRUE'),
       (4, '난바 오리엔탈', '해외', '3-4-24 Watanabedouri, Chuo-ku, 텐진, 후쿠오카 ', 33.5852054, 130.4051322, '여행지의 모든 것들을 가까이서 즐기는 숙소', '객실 내 취사 금지', now(),
        'TRUE'),
       (5, '캠핑 체험 랜드', '캠핑', '강원도 평창군 봉평면 대정로 253', 37.612259, 128.3467109, '자연 속에서 즐기는 힐링 캠핑', '야외 캠핑 체험 프로그램 제공', NOW(), 'TRUE'),
       (4, '산속 캠핑존', '캠핑', '전라남도 순천시 구룡포길 80-14', 34.99465670000001, 127.3894958,'산 속 조용한 캠핑 장소', '산림욕과 등산로 제공', NOW(), 'TRUE'),
       (2, '숲속 캠핑 풀빌라', '캠핑', '충청북도 제천시 양평면 목재로 148', 37.011553, 128.119516,'시원한 숲 속 풀빌라', '피크닉과 바베큐 시설 제공', NOW(), 'TRUE'),
       (1, '강가 캠핑장', '캠핑', '경기도 양평군 강상면 행목길 29-21', 37.4610636, 127.467692,'강가에 위치한 편안한 캠핑장', '낚시 및 수상 스포츠 활동 제공', NOW(), 'TRUE'),
       (6, '별빛 캠핑장', '캠핑', '경기도 가평군 설악면 금강로 1266', 37.6533238, 127.4991587,'별빛 아래 펼쳐지는 캠핑장', '야외 영화 상영 및 관광 버스 투어 제공', NOW(), 'TRUE'),
       (2, '모텔 더 포레스트', '모텔', '서울특별시 강남구 도곡로 156', 37.4909225, 127.0370751,'강남의 편안한 모텔', '24시간 룸 서비스 제공', NOW(), 'TRUE'),
       (5, '시티 모텔', '모텔', '서울특별시 마포구 와우산로 71', 37.5508822, 126.9228522,'마포의 시티 뷰를 감상하는 모텔', '근처 관광명소 안내 서비스 제공', NOW(), 'TRUE'),
       (4, '블랙모텔', '모텔', '대전광역시 중구 중앙로 123', 36.3280388, 127.4235713, '도심에서 조용한 휴식을 취하는 모텔', '실내 레스토랑 및 라운지 제공', NOW(), 'TRUE'),
       (3, '모텔 신세계', '모텔', '경기도 수원시 팔달구 권광로 190', 37.2720329, 127.034839, '수원의 중심에서 편안한 휴식을 취하는 모텔', '바디 마사지 서비스 제공', NOW(), 'TRUE'),
       (1, '카페모텔', '모텔', '경상북도 경주시 보문로 376', 35.8493404, 129.275579, '경주의 아늑한 모텔과 카페를 즐기세요', '무료 와이파이 및 모닝 콜 서비스 제공', NOW(), 'TRUE'),
       (5, '별빛 펜션', '펜션', '강원도 강릉시 경강로 3104', 37.7176223, 128.8048503, '강릉의 아름다운 풍경을 감상하는 펜션', '바베큐 파티 및 산책로 제공', NOW(), 'TRUE'),
       (6, '호수 펜션', '펜션', '전라남도 순천시 화양면 호수로 55', 34.99465670000001, 127.3894958, '호수에 인접한 조용한 펜션', '수영장 및 낚시 서비스 제공', NOW(), 'TRUE'),
       (2, '바다 푸른 펜션', '펜션', '경상남도 통영시 죽림면 세마해안로 176-8', 34.8551229, 128.4390198, '통영의 바다를 품은 펜션', '바다 수영 및 스쿠버 다이빙 체험 제공', NOW(), 'TRUE'),
       (2, '하늘과 바람과 별과 펜션', '펜션', '제주특별자치도 서귀포시 안덕면 상창로 25', 33.2793461, 126.360197, '제주의 맑은 하늘 아래서 힐링하는 펜션', '자전거 대여 및 야외 수영장 제공', NOW(),
        'TRUE'),
       (3, '산속 푸른 펜션', '펜션', '충청북도 충주시 산척면 매곡로 66', 37.08374990000001, 128.0047748, '산 속에서 바라보는 푸른 펜션', '등산로 및 자연체험 프로그램 제공', NOW(), 'TRUE'),
       (1, '럭셔리 빌라', '홈&빌라', '서울특별시 용산구 우사단로 54', 37.5325181, 126.9959438, '용산의 프라이빗한 럭셔리 빌라', '헬스장 및 사우나 시설 제공', NOW(), 'TRUE'),
       (1, '골목길 빌라', '홈&빌라', '서울특별시 마포구 와우산로 147', 37.5543812, 126.9293739, '마포의 아늑한 골목길 빌라', '카페 및 작은 공연장 제공', NOW(), 'TRUE'),
       (3, '연못빌라', '홈&빌라', '경기도 가평군 청평면 청평로 311', 37.73546899999999, 127.426589, '연못을 따라 펼쳐지는 힐링 빌라', '낚시 및 보트 서비스 제공', NOW(), 'TRUE'),
       (5, '수영장 빌라', '홈&빌라', '강원도 춘천시 국원로 228', 37.8758834, 127.732455, '시원한 수영장이 있는 편안한 빌라', '수영 및 바베큐 파티 서비스 제공', NOW(), 'TRUE'),
       (6, '산속 빌라', '홈&빌라', '경상북도 안동시 하회로 1길 7', 36.53891309999999, 128.5181474, '자연 속에서 즐기는 휴식을 위한 빌라', '산책로 및 템플스테이 프로그램 제공', NOW(), 'TRUE'),
       (1, '친구랑 편한 게스트하우스', '게스트하우스', '서울특별시 마포구 와우산로 109', 37.5509879, 126.9259968, '마포에서 편안한 하룻밤을 보내세요', '공용 주방 및 라운지 제공', NOW(), 'TRUE'),
       (2, '꿈나무 게스트하우스', '게스트하우스', '서울특별시 서대문구 연희로 4길 22', 37.5611329, 126.9280199, '연희동의 아늑한 게스트하우스', '투어 및 가이드 서비스 제공', NOW(), 'TRUE'),
       (5, '무지개 게스트하우스', '게스트하우스', '경기도 수원시 팔달구 경수대로 1035', 37.27662309999999, 127.0274394, '수원의 다양한 문화를 경험하세요', '자전거 대여 및 문화 이벤트 안내 제공', NOW(),
        'TRUE'),
       (3, '쉐어하우스', '게스트하우스', '경상남도 창원시 성산구 대방로 89', 35.2105603, 128.7254669, '창원에서 즐거운 쉐어하우스 경험', '공용 욕실 및 라운지 제공', NOW(), 'TRUE'),
       (4, '시골풍경 게스트하우스', '게스트하우스', '전라남도 담양군 금성면 비로산길 59-49', 35.3446581, 127.037654, '담양의 시골 풍경을 즐기는 게스트하우스', '산책로 및 체험 프로그램 제공', NOW(),
        'TRUE'),
       (3, '자연 속 캠핑장', '캠핑', '강원도 인제군 북면 평대리 109-7', 38.1661601, 128.3152353, '자연 속에서 휴식을 취하는 캠핑장', '숲속 캠프파이어 및 가족놀이터 제공', NOW(), 'TRUE'),
       (5, '호수 캠핑리조트', '캠핑', '전라북도 정읍시 북면 태조로 472-20', 35.5963659, 126.906225, '호수를 바라보며 즐기는 캠핑 리조트', '워터스포츠 및 낚시체험 제공', NOW(), 'TRUE'),
       (6, '별빛 텐트 캠핑장', '캠핑', '경기도 포천시 일동면 광릉수목원로 188', 37.7701008, 127.1475894, '별 아래서 자연을 느끼는 캠핑장', '텐트 대여 및 캠프파이어 서비스 제공', NOW(), 'TRUE'),
       (1, '강변 캠핑존', '캠핑', '경기도 양평군 강하면 양평로 434', 37.4680389, 127.4116765, '강변에서 느끼는 특별한 캠핑 경험', '바베큐 파티 및 수상 스포츠 제공', NOW(), 'TRUE'),
       (2, '여름별캠핑장', '캠핑', '충청남도 예산군 대술면 여름별로 123', 36.6666675, 126.9179108, '여름에 더욱 빛나는 캠핑장', '바닷가 풍경 및 해수욕 제공', NOW(), 'TRUE'),
       (3, '신라 모텔', '모텔', '서울특별시 서초구 서초대로 412', 37.4910405, 127.004581, '서초에서 편안한 하룻밤을 보내세요', '모던한 디자인 및 무료 와이파이 제공', NOW(), 'TRUE'),
       (4, '반짝모텔', '모텔', '부산광역시 해운대구 해운대로 320', 35.1822879, 129.1610253, '해운대의 반짝이는 모텔', '해변 근처 위치 및 룸 서비스 제공', NOW(), 'TRUE'),
       (2, '쉬고모텔', '모텔', '대구광역시 수성구 무학로 107', 35.8303589, 128.6204704, '수성구의 편안한 쉼터', '친절한 직원 및 조식 서비스 제공', NOW(), 'TRUE'),
       (6, '행복한모텔', '모텔', '대전광역시 서구 관저동로 87', 36.29988590000001, 127.3402171, '대전에서 행복한 하룻밤을 보내세요', '실내 미니바 및 에어컨 제공', NOW(), 'TRUE'),
       (2, '청춘모텔', '모텔', '광주광역시 동구 충장로 3', 35.1488678, 126.9151479, '동구에서 젊음을 느끼는 모텔', '주변 관광명소 안내 및 무료 주차장 제공', NOW(), 'TRUE'),
       (6, '느린마을 펜션', '펜션', '강원도 화천군 사내면 영춘로 8-24', 38.0729072, 127.5083932, '자연 속에서 느린 휴식을 취하는 펜션', '공용 바베큐 시설 및 피크닉 액티비티 제공', NOW(), 'TRUE'),
       (6, '푸른 호반의 펜션', '펜션', '전라북도 김제시 요촌면 김제영월로 139-12', 35.8068736, 126.8961044, '김제의 아름다운 호반을 감상하는 펜션', '수영장 및 자전거 대여 서비스 제공', NOW(),
        'TRUE'),
       (5, '수원의 펜션', '펜션', '경기도 수원시 영통구 영통로 97', 37.2371134, 127.0587664, '수원의 편안한 휴식을 제공하는 펜션', '실내 미니바 및 무료 주차장 제공', NOW(), 'TRUE'),
       (2, '산속 힐링 펜션', '펜션', '경기도 양평군 서종면 하산골길 137', 37.6093256, 127.4063411, '산 속에서 힐링하는 펜션', '산책로 및 자전거 대여 서비스 제공', NOW(), 'TRUE'),
       (3, '호수의 휴식 펜션', '펜션', '충청남도 보령시 미산면 청소로 36', 36.2430712, 126.682576, '보령의 아름다운 호수를 바라보는 휴식 펜션', '바베큐 파티 및 낚시체험 제공', NOW(), 'TRUE'),
       (2, '여름의 빌라', '홈&빌라', '제주특별자치도 서귀포시 성산읍 시흥하동로 409', 33.4741339, 126.906402, '성산일출봉 근처에서 여름을 보내는 빌라', '바다 전망 및 테라스 디자인 제공', NOW(),
        'TRUE'),
       (6, '평온한 빌라', '홈&빌라', '경기도 용인시 처인구 이동면 양지로 301', 37.2340047, 127.2854978, '양지의 평온한 휴식을 즐기는 빌라', '실내 난방 및 바베큐 시설 제공', NOW(), 'TRUE'),
       (1, '가을의 빌라', '홈&빌라', '강원도 춘천시 서면 서동천로 32', 37.898085, 127.64327, '서면의 가을을 느끼는 휴식의 빌라', '난방 시설 및 주변 산책로 제공', NOW(), 'TRUE'),
       (1, '행복한 홈스테이', '홈&빌라', '전라남도 완도군 완도읍 완도로 100', 34.3492205, 126.7274232, '완도의 행복을 느끼는 홈스테이', '가정적인 분위기와 가족식 밥상 제공', NOW(), 'TRUE'),
       (3, '바다 뷰 빌라', '홈&빌라', '부산광역시 해운대구 우동 우동해안로 298', 35.1743762, 129.147899,'해운대의 멋진 바다를 바라보는 빌라', '넓은 테라스 및 해수욕장 접근성 제공', NOW(), 'TRUE'),
       (1, '디자인 게스트하우스', '게스트하우스', '서울특별시 강남구 역삼로 123', 37.4942547, 127.0328547,'강남의 아름다운 디자인을 즐기는 게스트하우스', '주변 쇼핑 명소 안내 및 공항 셔틀 제공', NOW(),
        'TRUE'),
       (2, '하버 게스트하우스', '게스트하우스', '인천광역시 중구 해안남로 34', 37.6155254, 126.4204508,'인천 항구를 바라보는 게스트하우스', '공용 주방 및 바베큐 편의 시설 제공', NOW(), 'TRUE'),
       (3, '여유로운 게스트하우스', '게스트하우스', '대구광역시 중구 동성로 38', 35.8708214, 128.5955436,'중구에서 여유로운 휴식을 취하는 게스트하우스', '마사지 및 피트니스 센터 이용 가능', NOW(),
        'TRUE'),
       (6, '편안한 게스트하우스', '게스트하우스', '광주광역시 서구 서문대로 817', 35.1318887, 126.8999478,'서구에서 편안한 하룻밤을 보내는 게스트하우스', '주변 관광명소 안내 및 무료 주차장 제공', NOW(),
        'TRUE'),
       (5, '행복한 게스트하우스', '게스트하우스', '경기도 수원시 장안구 경수대로 924', 37.3085019, 127.0002715,'장안구에서 행복한 하룻밤을 보내는 게스트하우스', '조식 서비스 및 자전거 대여 제공', NOW(),
        'TRUE'),
        (4, '이비스 앰배서더 부산 시티호텔', '호텔', '부산시 부산진구 중앙대로 110 (부전동)', 35.158891, 129.058833, '부산 중심지에 위치한 편리한 시티호텔입니다.',
            '흡연 및 반려동물 불가', NOW(), 'TRUE'),
        (5, '브라운도트 호텔 서면 1호점', '호텔', '부산시 부산진구 중앙대로 692-18 (부전동)', 35.156637, 129.061267, '서면 중심에 자리한 아늑한 호텔입니다.',
         '무료 와이파이 제공', NOW(), 'TRUE'),
        (6, '토요코인호텔 부산서면', '호텔', '부산시 부산진구 서전로30번길 17-1 (부전동)', 35.155701, 129.060156, '경제적이면서 깨끗한 호텔입니다.', '조식 미제공',
         NOW(), 'TRUE'),
        (2, '호텔티티 서면', '호텔', '부산시 부산진구 중앙대로 658 (부전동)', 35.156993, 129.058897, '서면에서 휴식을 취할 수 있는 아늑한 호텔입니다.', '주차 가능',
         NOW(), 'TRUE'),
        (3, '롯데호텔 서면', '호텔', '부산시 부산진구 중앙대로 771 (부전동)', 35.156131, 129.058197, '서면의 중심에 자리한 고급 호텔입니다.',
         '스파 및 피트니스 센터 이용 가능', NOW(), 'TRUE');
...
values (1, '스위트룸', 'Deluxe', 'A101', 150000, 130000, 'APPLIED', 'room1.jpg', '/images/room1.jpg', now()),
       (1, '스탠다드룸', 'Standard', 'A102', 100000, 90000, 'APPLIED', 'room2.jpg', '/images/room2.jpg', now()),
       (2, '더블룸', 'Deluxe', '101', 120000, 100000, 'APPLIED', 'room1.jpg', '/images/room1.jpg', now()),
       (2, '싱글룸', 'Standard', '102', 80000, 70000, 'NOT_APPLIED', 'room2.jpg', '/images/room2.jpg', now()),
       (3, '프리미엄룸', 'Premium', '샛별동', 200000, 180000, 'APPLIED', 'room1.jpg', '/images/room1.jpg', now()),
       (3, '패밀리룸', 'Family', '햇빛동', 180000, 150000, 'APPLIED', 'room2.jpg', '/images/room2.jpg', now()),
       ...
       (5, '프리미엄룸', 'Premium', '샛별동', 200000, 180000, 'APPLIED', 'room2.jpg', '/images/room2.jpg', now()),
...
--faq_tb 더미생성
insert into faq_tb(admin_id, content, reply, created_at, classification)
values (1, '예약을 취소하고 싶어요', '예약취소는  앱/웹 > 내정보 > 예약/구매내역에서 직접 가능합니다.', now(), 'User'),
...
신청을 누락했거나 발행받지 못한 경우라면 영수증 확인 후 국세청에서 자진발급분을 등록해 주시길 바랍니다.', now(), 'User'),
       (2, '영수증/거래내역서 발급받고 싶어요', '예약 정보와 결제 정보가 기재되어 있는 영수증 또는 거래내역서는 아래의 경로를 통하여 발급받으실 수 있습니다.', now(), 'Common'),
       (4, '상품을 결제했는데 이용 횟수가 올라가지않아요',
        '실 결제금액 5만원 이상의 상품을 구매하고 이용 완료까지 하셔야 이용 횟수가 올라가요.더불어, 이용 횟수 반영까지 최대 3일 정도 소요될 수 있어요. ', now(), 'User'),
       (3, '새로운 숙소를 등록하려면 어떻게 해야 하나요?',
        '새로운 숙소를 등록하려면 관리자 포털에 로그인한 후 "숙소 관리" 섹션에서 "새 숙소 등록" 버튼을 클릭하여 필요한 정보를 입력하고 제출하세요. 승인이 완료되면 숙소가 목록에 표시됩니다.',
        now(), 'Company'),
       (3, '등록된 숙소 정보를 수정하려면 어떻게 해야 하나요?',
        '등록된 숙소 정보를 수정하려면 관리자 포털에 로그인한 후 "숙소 관리" 섹션에서 해당 숙소를 선택하고 "정보 수정" 버튼을 클릭하여 변경 사항을 입력한 후 저장하세요.',
        now(), 'Company'),

       (4, '숙소 예약 현황을 확인하고 싶어요',
        '숙소 예약 현황을 확인하려면 관리자 포털에 로그인한 후 "예약 관리" 섹션에서 현재 예약 상태를 확인할 수 있습니다. 상세 예약 정보도 확인 가능합니다.',
        now(), 'Company'),

       (4, '예약 취소 요청이 들어왔는데, 어떻게 처리해야 하나요?',
        '예약 취소 요청은 관리자 포털의 "예약 관리" 섹션에서 처리할 수 있습니다. 해당 예약을 선택하고 "취소 처리" 버튼을 클릭하여 취소 사유를 입력한 후 처리를 완료하세요.',
        now(), 'Company'),

       (5, '숙소의 리뷰 및 평점을 확인하려면 어떻게 해야 하나요?',
        '숙소의 리뷰 및 평점을 확인하려면 관리자 포털에 로그인한 후 "리뷰 관리" 섹션에서 해당 숙소의 리뷰와 평점을 확인할 수 있습니다. 리뷰에 대한 답변도 작성할 수 있습니다.',
        now(), 'Company');
...
insert into reservation_tb(user_id, room_id, reservation_name, reservation_tel, check_in_date, check_out_date,
                           created_at, amount_to_pay)
values
    -- 5월 24일 이전 예약
    (1, 1, '홍길동', '01012344321', '2023-12-31', '2024-01-01', '2023-12-29 13:00:00', 150000),
    (1, 1, '홍길동', '01012344321', '2024-01-01', '2024-01-02', '2023-12-30 15:00:00', 150000),
    (1, 2, '홍길동', '01012344321', '2024-02-01', '2024-02-02', '2024-01-01 13:00:00', 100000),
    (2, 3, '임꺽정', '01056788765', '2024-02-03', '2024-02-05', '2024-01-19 21:00:00', 120000),
    (2, 4, '임꺽정', '01056788765', '2024-02-29', '2024-03-02', '2024-02-15 14:00:00', 80000),
    (3, 5, '이순신', '01087654321', '2024-03-17', '2024-03-21', '2024-03-01 21:00:00', 200000),
    (3, 1, '이순신', '01087654321', '2024-04-23', '2024-04-27', '2024-04-19 09:00:00', 180000),
    -- 5월 24일 이후 예약
    (1, 1, '홍길동', '01012344321', '2024-05-24', '2024-05-25', now(), 0),
    (1, 2, '홍길동', '01012344321', '2024-05-25', '2024-05-30', now(), 0),
    (2, 3, '임꺽정', '01056788765', '2024-05-31', '2024-06-02', now(), 120000),
    (2, 4, '임꺽정', '01056788765', '2024-06-10', '2024-06-11', now(), 80000),
    (3, 5, '이순신', '01087654321', '2024-06-20', '2024-06-25', now(), 200000),
    (3, 6, '이순신', '01087654321', '2024-06-23', '2024-06-27', now(), 180000);
...
values (1, 1, 5, '정말 좋았어요!', 'FLAWLESS', now()),
       ...
       (2, 2, 5, '여기 진짜 구려요... 다시는 안갈듯', 'FLAWLESS', now());

-- review 대댓글 더미생성
insert into review_tb (company_id, stay_id, content, state, created_at, parent_id)
values (1, 1, '감사합니다!', 'FLAWLESS', now(), 1),
       (1, 2, '조금 더 노력하겠습니다!', 'FLAWLESS', now(), 2),
       (2, 3, '보통이면 최고가 되도록 노력하겠습니다!', 'FLAWLESS', now(), 3),
       (2, 3, '감사합니다 최선을 다하겠습니다!', 'FLAWLESS', now(), 4),
       (2, 3, '고마워요!', 'FLAWLESS', now(), 5);
...
values -- 호텔
       ...
       (58, 'hotel7.png', '/images/hotel/hotel7.png', now()),
       (59, 'hotel8.png', '/images/hotel/hotel8.png', now()),
       (60, 'hotel9.png', '/images/hotel/hotel9.png', now()),
       (61, 'hotel10.png', '/images/hotel/hotel10.png', now()),
       (62, 'hotel11.png', '/images/hotel/hotel11.png', now()),
       -- 해외

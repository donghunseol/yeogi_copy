...
--event_tb 더미생성
insert into event_tb(admin_id, name, start_date, end_date, created_at, image_name, image_path, state)
values (1, '국내숙소 쿠폰팩', '2024-04-04', '2024-04-15', now(), 'eventTitle1.png', '/images/event/event_title/eventTitle1.png', 'Disable'),
       (2, '위클리 오픈런', '2024-05-04', '2024-06-15', now(), 'eventTitle2.png', '/images/event/event_title/eventTitle2.png', 'Disable'),
       (2, '베스트 호텔딜', '2024-02-04', '2024-04-15', now(), 'eventTitle3.png', '/images/event/event_title/eventTitle3.png', 'Disable'),
       (4, '인기 호텔 최대 5만원할인', '2024-04-04', '2024-04-20', now(),'eventTitle4.png', '/images/event/event_title/eventTitle4.png', 'Enable'),
       (4, '피크닉여행 블랙어때', '2024-03-15', '2024-04-27', now(),'eventTitle5.png', '/images/event/event_title/eventTitle5.png', 'Enable');

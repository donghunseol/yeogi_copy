...
values (1, '호텔 블루 하버', '호텔', '부산시 해운대구 좌동순환로 99 (좌동)', '해운대 최고의 오션뷰를 자랑하는 숙소!', '객실 내 취사 금지', now(), 'TRUE'),
       ...
       (2, '하늘과 바람과 별과 펜션', '펜션', '제주특별자치도 서귀포시 안덕면 상창로 25', '제주의 맑은 하늘 아래서 힐링하는 펜션', '자전거 대여 및 야외 수영장 제공', NOW(), 'TRUE'),
       ...
       (5, '무지개 게스트하우스', '게스트하우스', '경기도 수원시 팔달구 경수대로 1035', '수원의 다양한 문화를 경험하세요', '자전거 대여 및 문화 이벤트 안내 제공', NOW(), 'TRUE'),
       (3, '쉐어하우스', '게스트하우스', '경상남도 창원시 성산구 대방로 89', '창원에서 즐거운 쉐어하우스 경험', '공용 욕실 및 라운지 제공', NOW(), 'TRUE'),
       (4, '시골풍경 게스트하우스', '게스트하우스', '전라남도 담양군 금성면 비로산길 59-49', '담양의 시골 풍경을 즐기는 게스트하우스', '산책로 및 체험 프로그램 제공', NOW(), 'TRUE'),
       ...
       (6, '푸른 호반의 펜션', '펜션', '전라북도 김제시 요촌면 김제영월로 139-12', '김제의 아름다운 호반을 감상하는 펜션', '수영장 및 자전거 대여 서비스 제공', NOW(), 'TRUE'),
       ...
       (2, '여름의 빌라', '홈&빌라', '제주특별자치도 서귀포시 성산읍 시흥하동로 409', '성산일출봉 근처에서 여름을 보내는 빌라', '바다 전망 및 테라스 디자인 제공', NOW(), 'TRUE'),
       ...
       (1, '디자인 게스트하우스', '게스트하우스', '서울특별시 강남구 역삼로 123', '강남의 아름다운 디자인을 즐기는 게스트하우스', '주변 쇼핑 명소 안내 및 공항 셔틀 제공', NOW(), 'TRUE'),
       (2, '하버 게스트하우스', '게스트하우스', '인천광역시 중구 해안남로 34', '인천 항구를 바라보는 게스트하우스', '공용 주방 및 바베큐 편의 시설 제공', NOW(), 'TRUE'),
       (3, '여유로운 게스트하우스', '게스트하우스', '대구광역시 중구 동성로 38', '중구에서 여유로운 휴식을 취하는 게스트하우스', '마사지 및 피트니스 센터 이용 가능', NOW(), 'TRUE'),
       (6, '편안한 게스트하우스', '게스트하우스', '광주광역시 서구 서문대로 817', '서구에서 편안한 하룻밤을 보내는 게스트하우스', '주변 관광명소 안내 및 무료 주차장 제공', NOW(), 'TRUE'),
       (5, '행복한 게스트하우스', '게스트하우스', '경기도 수원시 장안구 경수대로 924', '장안구에서 행복한 하룻밤을 보내는 게스트하우스', '조식 서비스 및 자전거 대여 제공', NOW(), 'TRUE');
...
values (1, '취소 수수료에 대한 질문', '안녕하세요, 숙소 예약 후에 긴급 상황이 발생하여 예약을 취소해야 할 경우에 대비해서 취소 수수료에 대해 알고 싶습니다',
       ...
       (3, '애완동물 동반 여부에 대한 질문', '숙소 예약 시 애완동물을 동반할 수 있는지 알고 싶습니다.', '숙소에 연락 후 당일예약취소 및 시간이 가능한지 물어보시고 진행하시면 됩니다.',
        now()),
       (3, '예약취소를 하고싶은데 어떻게해요?', '제가 실수로 예약을 잘못해서 그런데 당일 취소를 하고싶은데 예약취소가 안돼요',
        '숙소 예약 시 애완동물 동반 가능 여부는 숙소마다 다를 수 있습니다. 일부 숙소는 애완동물을 환영하고 있지만, 다른 숙소는 애완동물을 허용하지 않을 수도 있습니다. 애완동물 동반 가능 여부는 숙소 예약 시스템이나 숙소의 웹사이트에서 확인할 수 있습니다. 또한 예약 전에 숙소 관리자나 호스트에게 직접 문의하여 애완동물 동반 여부를 확인할 수도 있습니다.',
        now());
...
values (1, 'hotel.png', '/images/hotel.png', now()),
       ...
       (8, 'room2.jpg', '/images/room2.jpg', now()),
       (8, 'room2.jpg', '/images/room2.jpg', now()),
       (9, 'room2.jpg', '/images/room2.jpg', now()),
       (9, 'room2.jpg', '/images/room2.jpg', now()),
       (10, 'room2.jpg', '/images/room2.jpg', now()),
       (11, 'room2.jpg', '/images/room2.jpg', now()),
       (12, 'room2.jpg', '/images/room2.jpg', now()),
       (13, 'room2.jpg', '/images/room2.jpg', now()),
       (14, 'room2.jpg', '/images/room2.jpg', now()),
       (14, 'room2.jpg', '/images/room2.jpg', now()),
       (15, 'room2.jpg', '/images/room2.jpg', now()),
       (16, 'room2.jpg', '/images/room2.jpg', now()),
       (17, 'room2.jpg', '/images/room2.jpg', now()),
       (17, 'room2.jpg', '/images/room2.jpg', now()),
       (18, 'room2.jpg', '/images/room2.jpg', now()),
       (18, 'room2.jpg', '/images/room2.jpg', now()),
       (19, 'room2.jpg', '/images/room2.jpg', now()),
       (19, 'room2.jpg', '/images/room2.jpg', now()),
       (20, 'room2.jpg', '/images/room2.jpg', now()),
       (21, 'room2.jpg', '/images/room2.jpg', now()),
       (22, 'room2.jpg', '/images/room2.jpg', now()),
       (23, 'room2.jpg', '/images/room2.jpg', now()),
       (24, 'room2.jpg', '/images/room2.jpg', now()),
       (25, 'room2.jpg', '/images/room2.jpg', now()),
       (26, 'room2.jpg', '/images/room2.jpg', now()),
       (27, 'room2.jpg', '/images/room2.jpg', now()),
       (28, 'room2.jpg', '/images/room2.jpg', now()),
       (28, 'room2.jpg', '/images/room2.jpg', now()),
       (28, 'room2.jpg', '/images/room2.jpg', now()),
       (29, 'room2.jpg', '/images/room2.jpg', now()),
       (30, 'room2.jpg', '/images/room2.jpg', now()),
       (31, 'room2.jpg', '/images/room2.jpg', now()),
       (32, 'room2.jpg', '/images/room2.jpg', now()),
       (33, 'room2.jpg', '/images/room2.jpg', now()),
       (35, 'room2.jpg', '/images/room2.jpg', now()),
       (34, 'room2.jpg', '/images/room2.jpg', now()),
       (35, 'room2.jpg', '/images/room2.jpg', now()),
       (36, 'room2.jpg', '/images/room2.jpg', now()),
       (36, 'room2.jpg', '/images/room2.jpg', now()),
       (36, 'room2.jpg', '/images/room2.jpg', now()),
       (37, 'room2.jpg', '/images/room2.jpg', now()),
       (38, 'room2.jpg', '/images/room2.jpg', now()),
       (39, 'room2.jpg', '/images/room2.jpg', now()),
       (40, 'room2.jpg', '/images/room2.jpg', now()),
       (41, 'room2.jpg', '/images/room2.jpg', now()),
       (42, 'room2.jpg', '/images/room2.jpg', now()),
       (42, 'room2.jpg', '/images/room2.jpg', now()),
       (42, 'room2.jpg', '/images/room2.jpg', now()),
       (43, 'room2.jpg', '/images/room2.jpg', now()),
       (43, 'room2.jpg', '/images/room2.jpg', now()),
       (44, 'room2.jpg', '/images/room2.jpg', now()),
       (44, 'room2.jpg', '/images/room2.jpg', now()),
       (45, 'room2.jpg', '/images/room2.jpg', now()),
       (45, 'room2.jpg', '/images/room2.jpg', now()),
       (46, 'room2.jpg', '/images/room2.jpg', now()),
       (47, 'room2.jpg', '/images/room2.jpg', now()),
       (48, 'room2.jpg', '/images/room2.jpg', now()),
       (49, 'room2.jpg', '/images/room2.jpg', now()),
       (50, 'room2.jpg', '/images/room2.jpg', now()),
       (50, 'room2.jpg', '/images/room2.jpg', now()),
       (51, 'room2.jpg', '/images/room2.jpg', now()),
       (52, 'room2.jpg', '/images/room2.jpg', now()),
       (53, 'room2.jpg', '/images/room2.jpg', now()),
       (53, 'room2.jpg', '/images/room2.jpg', now()),
       (54, 'room2.jpg', '/images/room2.jpg', now()),
       (55, 'room2.jpg', '/images/room2.jpg', now()),
       (55, 'room2.jpg', '/images/room2.jpg', now()),
       (56, 'room2.jpg', '/images/room2.jpg', now()),
       (56, 'room2.jpg', '/images/room2.jpg', now()),
       (56, 'room2.jpg', '/images/room2.jpg', now()),
       (56, 'room2.jpg', '/images/room2.jpg', now()),
       (55, 'room2.jpg', '/images/room2.jpg', now()),
       ...
       (53, 'room2.jpg', '/images/room2.jpg', now()),
       (51, 'room2.jpg', '/images/room2.jpg', now()),
       (57, 'room2.jpg', '/images/room2.jpg', now());

...
--event_tb 더미생성
insert into event_tb(admin_id,name,start,end,state,created_at)
values (1,'국내숙소 쿠폰팩','2024-04-04','2024-06-20','Enable',now()),
       (2,'위클리 오픈런','2024-04-21','2024-05-20','Enable',now()),
       (2,'최대 5만원 할인 황금연휴 펜션특가','2024-05-04','2024-05-20','Disable',now()),
       (5,'피크닉여행 블랙어때','2024-01-04','2024-03-20','Disable',now()),
       (4,'인기공간 할인파티','2024-02-18','2024-04-3','Enable',now());
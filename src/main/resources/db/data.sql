...
values ('com1@nate.com', '1234', '김숙박회사', '108-32-34324', '부산시 해운대구', '01011112222', '김회사', 'ACTIVE', now(), 0),
       ...
       ('com6@nate.com', '1234', '해외숙소C회사', '793-48-93123', '말레이시아', '01077776666', 'C회사', 'BLACK', now(), 0),
       ('com7@nate.com', '1234', '스테이굿회사', '793-48-93123', '부산 해운대구', '01077776666', '이미자', 'PROGRESSING',now(), 0);
-- admin 더미 생성
...
values
    ...
    (3, 1, '이순신', '01087654321', '2024-04-23', '2024-04-27', '2024-04-19 09:00:00'),
    -- 5월 24일 이후 예약
    ...
    (3, 6, '이순신', '01087654321', '2024-06-23', '2024-06-27', now()),
    (1, 1, '홍길동', '01012344321', '2025-05-24', '2025-05-25', now());
...
values
    ...
    (14, 0, 'On Site Payment', 'PROCESSING', now());
